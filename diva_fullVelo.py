...
textRM2 + "\t3/2= " + textRM3)
	...
	self.controlVarDelta.set(len(Hmax)-len(H1))
	    ...
	    self.radioU[friend]= tk.Radiobutton(self,text=friend,image=self.image,variable=self.controlVar[friend],state='disabled')
	  ...
	  self.radioU[friend]= tk.Radiobutton(self,text=friend,image=self.image2,variable=self.controlVar[friend],state='disabled')
